...
import { ABOUT_HERO_DESKTOP, ABOUT_HERO_MOBILE } from "./aboutAssets";
import styles from "./AboutHero.module.css";

export default async function AboutHero() {
  const t = await getTranslations("about");
  const desktopHero = withBasePath(ABOUT_HERO_DESKTOP);
  const mobileHero = withBasePath(ABOUT_HERO_MOBILE);
    ...
    <section className={styles.aboutSection} data-page="about">
      ...
      <div className={styles.heroCard}>
        ...
        <div className={styles.heroContent}>
          ...
          <a href="#about-content" className={styles.btnPrimary}>
            {t("hero.cta")}
